<template>
    <div>
                ...
                <el-table :data="tableData">
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            {{ scope.row.commissionAmount }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ scope.row.tradeAmount }}笔
                        </template>
                    </el-table-column>
                </el-table>
            </div>
        ...
        <div class="baseListContent">
            <el-tabs v-model="commissionDetail">
                <el-tab-pane label="佣金明细" name="first">
                    <div class="recordSelect">
                        <el-form :model="commissionSelect" ref="commissionSelect" :rules="commissionSelectRules">
                            <el-row>
                                ...
                                <el-form-item>
                                    <el-button class="selectBtn" @click="searchCommHistory('commissionSelect')">搜索</el-button>
                                </el-form-item>
                            </el-row>
                        </el-form>
                    </div>
                    ...
                    <el-pagination v-if="pageVisible" @current-change="historyCurrentChange"
                                   ...
                                   :total="commHistoryData.totalCountApply"
