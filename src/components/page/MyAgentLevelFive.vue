<template>
    <div class="demo-table-expand">
        <el-table :data="levelFive" :show-header="showFiveHead">
            <el-table-column
                label="帐户名" label-width="120px"
                prop="IDName">
            </el-table-column>
            <el-table-column
                prop="role"
...
<script>
    module.exports = require('../pageJS/MyAgentLevelFive')
</script>
<style scoped="" lang="less">
    .demo-table-expand  .el-table__expanded-cell{
        padding: 3px;
    }
</style>
