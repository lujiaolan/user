    ...
    <div class="drawWrap">
        <div class=" ">
            <el-dialog :visible.sync="addbankConfigShow"  :title="titleAddbank" class="addBankConfig" :before-close="addBankClose">
                ...
                <el-form :model="bankConfigData" label-width="120px" ref="bankConfigData" :rules="bankConfigData_rules">
                    <el-row>
                        <el-col :span="8 ">
                            <el-form-item label="持卡人姓名：" >
                                <el-input v-model="bankConfigData.cardHolder" disabled="" @key.native.enter="sumitBankAdd('bankConfigData')"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="银行地址：" prop="bankAddress">
                                <el-input v-model="bankConfigData.bankAddress" @key.native.enter="sumitBankAdd('bankConfigData')"></el-input>
                            </el-form-item>
                            <el-form-item>
                                <el-button @click="sumitBankAdd('bankConfigData')" type="info">{{bankAddOrEdit?'修改':'保存'}}</el-button>
                                <el-button @click="cancelBankadd" type="info">取消</el-button>
                            </el-form-item>
                        </el-col>
        ...
        <div class="baseTableContent drawContent">
            ...
            <el-radio-group v-model="allBank" @change="changeSelectBank" class="addplus" >
                <el-radio-button v-for="item in bankInfo" :label="item.bankCardNumbers" :disabled="item.bankCardStatus==0||item.bankCardStatus==2">
                    ...
                    <el-button type="warning" size="" @click="delBankCard(item)" v-if="item.importantCard!==1">删除</el-button>
                    <el-button type="info" size=""  @click="modifyBanKCard(item)"
                               v-if="item.importantCard!==1&&item.bankCardStatus==1||item.bankCardStatus==2">修改</el-button>
        ...
        <div class="baseTableContent">
            ...
            <el-form ref="drawForm" :model="drawForm" :rules="drawFormRules"  label-width="80px">
                <el-form-item>
                    <label>钱包余额</label>
                    <el-input class="balanceMoney" disabled="disabled" v-model="drawForm.balance"></el-input>
                </el-form-item>
                <el-form-item>
                    <label>出金方式</label>
                ...
                <el-form-item >
                    <label>当前汇率</label>
                    <el-input v-model="drawForm.currentRate"></el-input>
                </el-form-item>
                <el-form-item prop="flowMoney">
                    <label>等值人民币(￥)</label>
