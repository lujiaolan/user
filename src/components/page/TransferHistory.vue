<template>
    <div class="baseListContent transH">
        <div class="infoList-title">
            <span>记录查询</span>
            <el-tabs v-model="transActiveName">
                <el-tab-pane label="已完成" name="transComplete">
                    <div class="recordSelect">
                        <el-form :model="recordSelect" ref="recordSelect" :rules="recordSelectRules">
                            ...
                            <el-form-item>
                                <el-button style="margin-left: 20px" @click="searchTransHistory('recordSelect')">搜索</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
