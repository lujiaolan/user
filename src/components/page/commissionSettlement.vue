            ...
            <el-tabs v-model="activeName" @tab-click="activeChange">
                <el-tab-pane label="结算佣金" name="countCom">
                    <div class="recordSelect">
                        <el-form :model="commissionHandle" ref="commissionHandle" :rules="commissionHandleRules">
                            <el-row>
                                ...
                                <el-form-item>
                                    <el-button class="selectBtn" @click="searchApplyList('commissionHandle')" style="margin-left: 30px">搜索</el-button>
                                    <el-button class="selectBtn" @click="refreshApplyList">刷新</el-button>
                                </el-form-item>
                    ...
                    <div class="leftPart" style="margin-left: 28%;margin-top: 30px">
                        ...
                        <el-button type="primary" @click="commissionApply">确认结算</el-button>
                    </div>
                    <div class="rightPart">
                ...
                <el-tab-pane label="结算记录" name="MT4Count" class="MT4Count">
                    <el-tabs v-model="activeName2" type="card" @tab-click="dealStatusChange" class="commissionTab">
                        <el-tab-pane label="等待处理" name="2">
                        ...
                        <el-tab-pane label="全部" name="4">
                            <el-table :data="dealTableData">
                                ...
                                <el-table-column label="佣金明细">
                                    <template scope="scope">
                                        <el-button size="small" @click="commissionDetailShow(scope.row)">详情</el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                            <div class="leftPart">
